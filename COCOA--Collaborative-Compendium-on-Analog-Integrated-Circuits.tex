...
\begin{tcolorbox}[enhanced jigsaw, colback=white, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Chapter Objectives}, leftrule=.75mm, breakable, rightrule=.15mm, opacityback=0, left=2mm, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-tip-color-frame, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, titlerule=0mm, bottomrule=.15mm]
